...
import { file, $, write, spawn, sleep } from "bun";
...
import type { ResponseType, CLIOptions } from "./utils/types";
      ...
      types: [
        {
          ...
          callback: function (name: string) {
            return `bun init --react=shadcn ${name}`;
          },
        },
        {
          value: "vite",
        ...
        },
        {
          ...
          hint: "👍 full-stack",
          callback: function (name: string) {
            return `bun create @tanstack/start@latest ${name} --tailwind --add-ons shadcn`;
          },
        },
      ],
    },
      ...
      types: [
        {
          ...
          callback: function (name: string) {
            return `quarto create project default ${name} --no-open --no-prompt --quiet`;
          },
        },
        {
          value: "manuscript",
          ...
          hint: "👍 for print",
          callback: function (name: string) {
            return `quarto create project manuscript ${name} --no-open --no-prompt --quiet`;
          },
        },
        // {
        //   value: "book",
